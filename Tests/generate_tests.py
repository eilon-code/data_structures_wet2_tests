...
def main(test_count, line_count, add_rank_tests):
    ...
    for i in range(1, test_count + 1):
        ...
        if i != 1:
            with open(input_file, "w") as f:
                f.write(input_generate.generate(line_count, add_rank_tests))
        else:
...
if __name__ == "__main__":
    ...
    parser.add_argument("add_rank_tests", type=str, help="Does your code support ")
    args = parser.parse_args()
    main(args.test_count, args.line_count, args.add_rank_tests=="True")
